...
- **Acceptance Criteria:**
  - [x] Class implements `CodeParser` interface
  - [x] Detects `.java` files and routes to JavaParser
  - [x] Handles parsing errors gracefully
  - [x] Returns structured chunks with metadata
...
- **Acceptance Criteria:**
  - [x] Extracts class name and fully qualified name
  - [x] Extracts package declaration
  - [x] Extracts class modifiers (public, abstract, final, etc.)
  - [x] Captures accurate line ranges for each class
...
- **Acceptance Criteria:**
  - [x] Extracts method name and signature
  - [x] Extracts parameter names and types
  - [x] Extracts return type
  - [x] Extracts method modifiers (public, static, etc.)
  - [x] Captures accurate line ranges for each method
...
- **Dependencies:** T1, T2 (needs JavaParserService and class context)
- **Acceptance Criteria:**
  - [x] Extracts field name and type
  - [x] Extracts field modifiers (public, private, static, final, etc.)
  - [x] Captures accurate line ranges for each field
  - [x] Handles field initialization expressions
...
- **Acceptance Criteria:**
  - [x] Inner classes extracted as separate entities
  - [x] Static nested classes extracted as separate entities
  - [x] Anonymous classes handled (if applicable)
...
- **Acceptance Criteria:**
  ...
  - [x] Language set to "java"
  - [x] Entity type correctly set (class/method/field)
  - [x] Entity name is fully qualified where appropriate
...
- **Acceptance Criteria:**
  - [x] Syntax errors logged with file path and error details
  - [x] Parsing continues for other files after error
  - [x] Partial parsing attempted when possible
...
- **Acceptance Criteria:**
  - [x] Unit tests cover all entity types (class, method, field)
  - [x] Tests include inner classes, interfaces, enums
  - [x] Tests verify metadata correctness
  - [x] Test coverage >80%
  - [x] Tests include edge cases (empty classes, single-line methods, etc.)
...
- **Assignee:** Implemented (basic throughput check; JMH benchmark can extend)
- **Status:** Done
- **Dependencies:** T1-T8 (needs complete implementation and tests)
- **Acceptance Criteria:**
  - [x] Benchmark test measures LOC per minute
